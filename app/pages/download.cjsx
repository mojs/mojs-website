    ...
    <div className="page download-page #{className}">
      <div className="download-page__content">
        ...
        <div className="download-page__options code-block">
            ...
            <UniteLink
              type="button"
              link=""https://.jsdelivr.net/mojs/latest/mo.min.js"
              download
        ...
        <div className="download-page__options code-block">
          ...
          <div className="code-block__body download-page__quick-start-normal">
            <PrismCode className="language-markup">
              {'<script src=""https://.jsdelivr.net/mojs/latest/mo.min.js"></script>'}
            </PrismCode>
          </div>
...
#   {'<script src=""https://.jsdelivr.net/mojs/0.119.0/mo.min.js"></script>'}
# </pre>
